<template>
    <div class="container vh-100 d-flex align-items-center justify-content-center positions">
      <div class="row h-100">
        <div class="col-12 d-flex align-items-center justify-content-center">
          <div class="text-center">
            ...
            <h4 class="p-1">Your messages</h4>
            <h6 class="text-secondary p-1">Send private photos and messages to a friend or group</h6>
            <button class="btn btn-primary p-1"> Send message</button>
          </div>
        </div>
      </div>
    </div>
